...
impl DataTypeTrait<NodeGraphState> for NodeDataType {
    fn data_type_color(&self, _user_state: &mut NodeGraphState) -> egui::Color32 {
        match self {
            ...
            NodeDataType::RenderPass => egui::Color32::from_rgb(70, 0, 128),
    ...
    fn name(&self) -> Cow<'_, str> {
        Cow::Borrowed(match self {
            ...
            NodeDataType::UVec2 => "2d unsigned integer vector",
            NodeDataType::UVec3 => "3d unsigned integer vector",
            NodeDataType::Filepath => "filepath",
            ...
            NodeDataType::RenderPass => "render pass",
